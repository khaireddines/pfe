...
<head>
    ...
    <title>ActivityLog - Created by AceVel Team</title>
    {{-- Styles --}}
...
<nav class="navbar navbar-expand-md navbar-dark sticky-top bg-dark p-0">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item {{ Route::is('Activitylog') ? 'active' : '' }}">
...
<footer class="main-footer">
    <div class="container-fluid">
        <p class="text-muted pull-left">
            Activity-LogViewer - <span class="badge badge-info">version {{ log_viewer()->version() }}</span>
        </p>
        <p class="text-muted pull-right">
            Created with <i class="fa fa-heart"></i> by ACEVEL TEAM <sup>&copy;</sup>
        </p>
    </div>
</footer>

{{-- Scripts --}}
<script src="{{asset('js/jquery-2.1.3.min.js')}}" crossorigin="anonymous"></script>
